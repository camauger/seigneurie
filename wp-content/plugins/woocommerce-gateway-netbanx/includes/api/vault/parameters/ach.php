 ...
 */
class Ach extends Parameters_Abstract {
	...
	public function create_from_single_use_token_parameters( $token, $profile_id ) {
		...
		wc_paysafe_add_debug_log( 'ACH: Create from single-use token parameters: ' . print_r( $params, true ) );
	...
	public function update_from_single_use_token_parameters( $profile_id, $card_id, $single_use_token ) {
		...
		wc_paysafe_add_debug_log( 'ACH: Update from single-use token parameters: ' . print_r( $params, true ) );
	...
	public function delete_method_parameters( $wc_token ) {
		...
		wc_paysafe_add_debug_log( 'ACH: Delete token parameters: ' . print_r( $params, true ) );
