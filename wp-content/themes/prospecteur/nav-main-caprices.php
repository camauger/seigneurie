<div class="row bg-head" style="background-image: url(<?php modifierBackground(); ?>); padding-top: .75em;">
     <div class="col-lg-12 entete-noel hidden">
     ...
     <div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
        ...
        <!-- /.row -->
        <?php echo do_shortcode( '[wpv-view name="citation-lait-caprices"]' ); ?>

        <a href="<?php echo ( ICL_LANGUAGE_CODE == 'en' ) ? '/en/' : '/'; ?>" title="Accueil"><img class="sio-logo" src="<?php bloginfo('template_directory'); ?>/images/sio-logo-chevre.png" alt="" title=""></a>
