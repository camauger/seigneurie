...
<div class="site" id="page">
	...
	<?php if ($bannerUrl === '') { ?>
		<div class="top-header-banner__image" style="background-image: url('https://seigneurieiledorleans.com/wp-content/themes/prospecteur/images/bg-champ-lavande.jpg');">
	<?php } else { ?>
...
se conjuguent au même temps... au présent!</span>
		...
		<div class="top-header-banner__logo">
			<a href="/">
			<img src="https://seigneurieiledorleans.com/wp-content/themes/prospecteur/images/sio-logo.png" alt="Seigneurie de l'Île d'Orélans">
			</a>
		</div>
	...
	<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
		...
		<div class="deco-left">
			<img src="https://seigneurieiledorleans.com/wp-content/themes/prospecteur/images/sio-ferronerie-gauche-1.png" alt="">
		</div>
		<div class="deco-right">
			<img src="https://seigneurieiledorleans.com/wp-content/themes/prospecteur/images/sio-ferronerie-droite-1.png" alt="">
		</div>
